...
${OBJECTDIR}/source/Calibrator.o: source/Calibrator.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Calibrator.o source/Calibrator.cpp

${OBJECTDIR}/source/ElementDetector.o: source/ElementDetector.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/ElementDetector.o source/ElementDetector.cpp
...
${OBJECTDIR}/source/SASimple.o: source/SASimple.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/SASimple.o source/SASimple.cpp
